			...
			<View className="w-full bg-zinc-900 p-4 rounded-xl my-8 border border-zinc-800">
				<Input>
					...
					<Input.Field
						...
						className={`w-full text-lg text-zinc-400 ${
							stepForm === StepForm.ADD_EMAIL && "text-zinc-700"
						}`}
				...
				<Button onPress={handleNextStepForm} isLoading={isCreatingTrip}>
					...
					{stepForm === StepForm.TRIP_DETAILS ? (
						...
						<Check color={colors.lime[950]} size={20} />
					)}
				</Button>
			</View>
				...
				<View className="gap-4 mt-4">
					<Input variant="secondary">
						...
						<Input.Field
							...
							onChangeText={(text) =>
								setEmailToInvite(text.toLowerCase())
							}
							value={emailToInvite}
							returnKeyType="send"
